...
const PAGE_ENTRIES: AdminSearchEntry[] = [
  ...
  { id: "page-schedule-projections", kind: "page", label: "Escala · Projeções", group: "Escala", path: "/admin/escala/projecoes", requiredTab: "schedule.projecoes", keywords: ["capacidade", "oferta", "demanda", "aceitar alunos", "projecao", "manutencao"] },
  ...
  { id: "page-reports-instructors", kind: "page", label: "Relatórios de instrutores", group: "Relatórios", path: "/admin/relatorios/instrutores", requiredTab: "reports.instrutores", keywords: ["instrutores", "repasse", "pagamento", "ground school"] },
  ...
  { id: "page-contents-painel", kind: "page", label: "Painel interativo", group: "Conteúdos", path: "/admin/conteudos/painel", requiredTab: "contents.painel", keywords: ["painel", "instrumento", "cockpit", "hotspot", "mockup", "3d", "glb"] },
  ...
  { id: "page-contents-fpl-sim", kind: "page", label: "Simulador FPL", group: "Conteúdos", path: "/admin/conteudos/simulador-fpl", requiredTab: "contents.fpl-sim", keywords: ["fpl", "plano de voo", "pvs", "pvc", "mca", "decea", "simulador"] },
  { id: "page-provas-banco", kind: "page", label: "Provas · Banco", group: "Operação", path: "/admin/provas", requiredTab: "provas.banco", keywords: ["prova", "questao", "teste", "exame", "multipla escolha"] },
  { id: "page-provas-liberacoes", kind: "page", label: "Provas · Liberações", group: "Operação", path: "/admin/provas/liberacoes", requiredTab: "provas.liberacoes", keywords: ["liberar prova", "aluno", "resultado", "nota"] },
...
const ACTION_ENTRIES: AdminSearchEntry[] = [
  ...
  { id: "action-add-instructor-candidate", kind: "action", label: "Cadastrar candidato a instrutor", group: "Ações", path: "/admin/admissao-instrutores", requiredTab: "instructor-admission", keywords: ["novo candidato", "adicionar instrutor", "candidatura instrutor"] },
  { id: "action-edit-instructor-form", kind: "action", label: "Editar formulário de admissão", group: "Ações", path: "/admin/admissao-instrutores", requiredTab: "instructor-admission", scrollTo: "Instrutores", keywords: ["formulario instrutor", "campos candidatura", "anexo instrutor"] },
