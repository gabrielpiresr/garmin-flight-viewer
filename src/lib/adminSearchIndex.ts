...
const PAGE_ENTRIES: AdminSearchEntry[] = [
  ...
  { id: "page-settings-onboarding", kind: "page", label: "Configurações · Onboarding", group: "Configurações", path: "/admin/configuracoes/onboarding", requiredTab: "settings.onboarding", keywords: ["boas-vindas", "primeiros passos", "apresentacao"] },
